...
public class PoetryUnresolvedReferencesInspection extends PyInspection {
    ...
    public static class Visitor extends PoetryUnresolvedReferencesVisitor {
                ...
                if (!components.isEmpty()) {
                    ...
                    if (module != null && sdk != null && PyPackageUtil.packageManagementEnabled(sdk)) {
                        return StreamEx
                                ...
                                .flatCollection(pkg -> getInstallPackageActions(pkg, module, sdk));
                    }
                }
            }
        ...
        private static List<LocalQuickFix> getInstallPackageActions(String packageName, Module module, Sdk sdk) {
            ...
            final String name = "Install package " + packageName + " by poetry";
            result.add(new PoetryPackageRequirementsInspection.PyInstallRequirementsFix(name, module, sdk, requirements, false));
            result.add(new PoetryPackageRequirementsInspection.PyInstallRequirementsFix(name, module, sdk, requirements, true));
            return result;
        }
...
//        }
                ...
                if (!components.isEmpty()) {
                    ...
                    if (PyPIPackageUtil.INSTANCE.isInPyPI(packageName) && PythonSdkUtil.findPythonSdk(module) != null) {
                        result.add(new PoetryPackageRequirementsInspection.InstallAndImportQuickFix(packageName, packageName, node, false));
                        result.add(new PoetryPackageRequirementsInspection.InstallAndImportQuickFix(packageName, packageName, node, true));
                    } else {
                        ...
                        if (packageAlias != null && PyPIPackageUtil.INSTANCE.isInPyPI(packageName) && PythonSdkUtil.findPythonSdk(module) != null) {
                            result.add(new PoetryPackageRequirementsInspection.InstallAndImportQuickFix(packageAlias, packageName, node, false));
                            result.add(new PoetryPackageRequirementsInspection.InstallAndImportQuickFix(packageAlias, packageName, node, true));
                        }
                    }
                }
            }
